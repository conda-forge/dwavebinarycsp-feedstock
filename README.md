...
Once the `conda-forge` channel has been enabled, `dwavebinarycsp` can be installed with:

```
conda install dwavebinarycsp
```

It is possible to list all of the versions of `dwavebinarycsp` available on your platform with:
